...
public class Aluno extends Pessoa {
	 ...
	 */
	public Aluno(String nome, String cpf, Instrutor instrutor) {
		super(nome, cpf);
	 ...
	 */
	public Aluno(String nome, String cpf, long matricula, int idade, double peso, double altura, Instrutor instrutor) {
		this(nome, cpf, instrutor);
	...
	public String getResumo() {
		return "Aluno: " + getNome() + " | Matrícula: " + getMatricula();
	}
